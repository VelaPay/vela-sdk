...
export declare function createEventSchema<TEventType extends string, TShape extends z.ZodRawShape = z.ZodRawShape>(eventType: TEventType, shape?: TShape): z.ZodObject<{
    id: z.ZodString;
    schema_version: z.ZodLiteral<1>;
    emitted_at: z.ZodNumber;
    signature: z.ZodString;
